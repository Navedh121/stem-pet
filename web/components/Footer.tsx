// Quiet footer.
// Product-facing text uses "MathBot"; "STEMPet" appears only in the legal copyright line.
    ...
    <footer className="border-t border-silk/10 py-10 px-6">
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-display text-sm text-silk">MathBot</span>
        </div>

        {/* Legal fine print — STEMPet is the company name */}
